...
from sopno.tools.builtins.dev.terminal import (
    _blocked_reason,
    _close,
    _engine,
    _format_output,
...
class TestRunTerminal(unittest.TestCase):
    ...
    def test_blocked_command_not_executed(self) -> None:
        with patch("sopno.tools.builtins.dev.terminal._engine") as mock_factory:
    ...
    def test_success(self) -> None:
        ...
        with patch("sopno.tools.builtins.dev.terminal._engine", return_value=mock_engine):
...
class TestEngineLifecycle(unittest.TestCase):
    ...
    def test_lazy_creation_and_reuse(self) -> None:
        ...
        with patch("sopno.tools.builtins.dev.terminal.Engine", return_value=fake):
            first = _engine()
            second = _engine()
